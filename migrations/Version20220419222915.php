 ...
 */
final class Version20220419222915 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE trip CHANGE trip trip VARCHAR(255) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE trip CHANGE trip trip VARCHAR(255) DEFAULT NULL');
    }
}
